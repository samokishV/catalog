...
describe("TypeSizesService Tests", function() {
    describe("#getAll()", function() {
        const type = [{id: 1, name: "shoes"}, {id: 2, name: "dress"}];
        const sizes: Array<Sizes> = [{id: 1, value: '44'}, {id: 2, value: '45'}, {id:3, value: 'XL'}];
        const typeSizes = [{id: 1, typeId: 1, sizeId: 1}, {id: 2, typeId: 1, sizeId: 2}, {id: 3, typeId: 2, sizeId: 3}];
        const expected : Array<Types> = [{id: 1, name: "shoes", sizes: [{id: 1, value: '44'}, {id: 2, value: '45'}]}, 
